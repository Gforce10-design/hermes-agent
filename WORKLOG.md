...
### 검증
- `python -m pytest tests/hermes_cli/test_commands.py tests/hermes_cli/test_korean_command_descriptions.py tests/hermes_cli/test_gateway_service.py tests/plugins/test_openclaw_bridge_plugin.py tests/gateway/test_telegram_conflict.py -q` → 241 passed
- `python -m py_compile hermes_cli/commands.py hermes_cli/config.py plugins/openclaw-bridge/__init__.py gateway/platforms/telegram.py` → 통과
- 독립 리뷰어 검증 → 통과
